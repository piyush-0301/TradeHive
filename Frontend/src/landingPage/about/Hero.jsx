...
const Hero = () => {
  return (
    <div className='container mt-5 px-5'>
      <h1 className='text-center mt-5 mb-5 py-5'>We pioneered the discount broking model in India. <br />
        Now, we are breaking ground with our technology.</h1><hr />
      <div className="row mt-5 px-5">
        <div className="col p-5 " style={{ fontSize: "1rem" }}>
